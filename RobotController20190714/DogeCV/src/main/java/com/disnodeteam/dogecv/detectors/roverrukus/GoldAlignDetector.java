...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public RatioScorer      ratioScorer        = new RatioScorer(1.0, 3);//pr 1.0, weight 3
    public MaxAreaScorer    maxAreaScorer      = new MaxAreaScorer( 0.05);//0.01
    public PerfectAreaScorer perfectAreaScorer = new PerfectAreaScorer(5000,0.05);//pa 5000, weight 0.05
